...
public class Jogo {
    ...
    public void distribuirCartas() {
        ...
        Usuario.exibeCartaVirada(cartaVirada);
    ...
    private Carta jogada(int index, Carta cartaMesa) {
        ...
        Usuario.exibeCartaJogada(jogadores.get(index).nome, carta);
        return carta;
    }
    ...
    private void defineVencedorETrocaOrdemParaProximaRodada(Rodada rodada) {
        ...
        Usuario.vencedorRodada(rodada.ganhador, jogadores.get(0), jogadores.get(1));
